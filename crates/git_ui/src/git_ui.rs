...
use crate::{
    ...
    solo_diff_view::{SoloDiffBase, SoloDiffView},
...
fn open_file_diff(
    ...
    window.defer(cx, move |window, cx| {
        let base = SoloDiffBase::for_entry(&entry);
        SoloDiffView::open_or_focus(entry, base, repository, workspace.clone(), window, cx)

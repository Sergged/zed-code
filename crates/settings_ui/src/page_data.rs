    ...
    fn git_panel_section() -> [SettingsPageItem; 19] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Minimum number of lines of height the commit message editor should have.",
                field: Box::new(SettingField {
                    organization_override: None,
                    json_path: Some("git_panel.message_editor_min_lines"),
                    pick: |settings_content| {
                        settings_content
                            .git_panel
                            .as_ref()?
...
fn non_editor_language_settings_data() -> Box<[SettingsPageItem]> {
    ...
    fn lsp_completions_section() -> [SettingsPageItem; 5] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Selection",
                description: "Controls which completion is preselected when the completions menu opens.",
                field: Box::new(SettingField {
                    organization_override: None,
                    json_path: Some("languages.$(language).completions.suggest_selection"),
                    pick: |settings_content| {
                        language_settings_field(settings_content, |language| {
                            language.completions.as_ref()?.suggest_selection.as_ref()
                        })
                    },
                    write: |settings_content, value, _| {
                        language_settings_field_mut(settings_content, value, |language, value| {
